				...
				<form method="post" class="tabbed" id="reg-sub" onsubmit="return formValidate()" action="PostNewMember.php">
					<div id="tabs-1"  class="tabbs">
						<div id="reg-form-1" class="reg-form">
							...
							<table class="fill"3 align="center" border="0" id="passwords">
								...
								<tr>
									<td><button type="submit" class="center" name="signup">Update</button></td>
								</tr>
							</table>
						</div>
					</div>
					<div id="tabs-2"  class="tabbs">
						<div id="reg-form-2" class="reg-form">
							<table class="fill" align="center" border="0">
								<tr>
									<td><input type="tel" name="phone" id="phone" placeholder="555-555-5555" maxlength="12" value="<?=htmlspecialchars($phone)?>"/></td>
								</tr>
								<tr>
									<td><input type="text" name="addr1" id="addr1" placeholder="Address 1" value="<?=htmlspecialchars($addr1)?>"/></td>
								</tr>
								<tr>
									<td><input type="text" name="addr2" id="addr2" placeholder="Address 2" value="<?=htmlspecialchars($addr2)?>" /></td>
								</tr>
								<tr>
									<td><input type="text" name="city" id="city" placeholder="City" value="<?=htmlspecialchars($city)?>"/></td>
								</tr>
								<tr>
									<td><input type="text" name="state" id="state" placeholder="State" value="<?=htmlspecialchars($state)?>" maxlength="2"/></td>
								</tr>
								<tr>
									<td><input type="text" name="zip" id="zip" placeholder="ZIP Code" value="<?=htmlspecialchars($zcode)?>" maxlength="5"/></td>
								</tr>
							</table>
						</div>
					</div>
...
<!--								</tr>-->
<!--								<tr>-->
<!--									<td><button type="submit" class="center" name="signup">Confirm</button></td>-->
<!--								</tr>-->
<!--							</table>-->
<!--						</div>-->
<!--					</div>-->
